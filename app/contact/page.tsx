...
export default function ContactPage() {
  return (
    <main className="mx-auto max-w-2xl px-6 py-24">
      <p className="op-reveal op-reveal-1 text-xs font-semibold tracking-[0.3em] text-amber">CONTACT</p>
      <h1 className="op-reveal op-reveal-2 mt-3 font-display text-4xl text-text sm:text-5xl">Talk to the Team</h1>
      <p className="op-reveal op-reveal-3 mt-6 text-base text-text-dim">
      ...
      <form
        ...
        method="post"
        encType="text/plain"
        className="op-reveal op-reveal-4 op-card mt-12 space-y-6 p-8"
      >
        <div>
        ...
        <button type="submit" className="op-btn-ripple rounded-sm bg-amber px-8 py-3 text-sm font-semibold tracking-wide text-obsidian transition hover:bg-amber-dim">
          Send Message
        </button>
