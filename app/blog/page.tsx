...
export default function BlogPage() {
  return (
    <main className="mx-auto max-w-4xl px-6 py-24">
      <p className="op-reveal op-reveal-1 text-xs font-semibold tracking-[0.3em] text-amber">INSIGHTS</p>
      ...
      <div className="op-reveal op-reveal-4 mt-14 space-y-8">
        {posts.map((p) => (
          <Link key={p.slug} href={`/blog/${p.slug}`} className="op-card block p-8">
